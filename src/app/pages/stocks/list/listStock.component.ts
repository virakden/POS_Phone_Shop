...
import { ProductsService } from './listStock.service';
...
export class listStockComponent {
  ...
  constructor(private modalService: NgbModal,public service: ProductsService, private formBuilder: FormBuilder) {
  ...
  getPro() {
    this.service.getObj().subscribe(res => {
      ...
      console.log('product:', of(this.ProductData));
