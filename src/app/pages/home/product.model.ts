...
export const productList: productModel[] = [
  {
      id: 1,
      images: ['assets/images/products/img-1.png', 'assets/images/products/img-2.png', 'assets/images/products/img-3.png'],
    ...
    //   features: ['Full Sleeve', 'Full Sleeve', 'All Sizes available', '4 Different Color'],
      services: ['Warranty 1year', 'Cash in shop available'],
      colorVariant: [{
          key: 'Gray',
